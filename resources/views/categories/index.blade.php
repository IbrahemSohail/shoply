@include('./nav')
          ...
          <div id="searchResults" class="mt-4"></div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-8">
              ...
              <div class="bg-indigo-400 rounded-2xl category-item hover:shadow-2xl hover:scale-105 transition duration-300 ease-in-out flex flex-col h-full"> 
                <a href="{{ route('category.products', $category) }}" class="flex-grow">
