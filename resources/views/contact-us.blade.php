...
<div class="container my-8 sm:my-12 mx-auto px-4 sm:px-2 md:px-4">
    ...
    <section class="mb-16 sm:mb-32">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <form class="w-full lg:w-5/12 px-4 sm:px-3 lg:px-6">
            ...
            <div class="w-full lg:w-7/12 px-4 sm:px-3 lg:px-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-4">
                    <div class="flex flex-col items-start">
                        <div class="shrink-0">
                            <div class="inline-block rounded-md bg-teal-400-100 p-3 sm:p-4 text-black">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="2" stroke="currentColor" class="h-5 w-5 sm:h-6 sm:w-6">
