        ...
        <div class="flex flex-wrap">
            ...
            <form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <div class="mb-3 w-full">
                    <label class="block font-medium mb-[2px] text-black" htmlFor="exampleInput90">
                            Name
                    </label>
                ...
                <button type="button"
                        class="mb-6 inline-block w-full rounded bg-indigo-400 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-indigo-600">
                        Send
                </button>
                ...
                <div class="flex flex-wrap">
                    <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                        <div class="flex items-start">
                            <div class="shrink-0">
                                <div class="inline-block rounded-md bg-teal-400-100 p-4 text-black">
